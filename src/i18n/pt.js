export default {
  ...
  hero: {
    ...
    subtitle:
      'Contas, tarefas, compras e avisos, tudo num app só, dividido de forma justa entre os moradores. Chega de cobrar todo mundo.',
  ...
  mockup: {
    greeting: 'Olá, Evandro',
    location: 'Você está em Pohlman Street',
    house: 'Pohlman Street',
    roommateCount: '4 moradores',
    nav: { home: 'Início', bills: 'Contas', chores: 'Tarefas', shopping: 'Compras', maintenance: 'Manutenção' },
    youOwe: 'Você deve',
    owedToYou: 'Devem a você',
    monthBadge: 'Mês',
    roommateOfMonth: 'Morador do mês',
    upcomingBills: 'Próximas contas',
    upcomingTasks: 'Próximas tarefas',
    rent: 'Aluguel',
    rentDue: 'Vence 21 de jul.',
    takeOutTrash: 'Tirar o lixo',
    cleanBathroom: 'Limpar banheiro',
  },
  problem: {
  ...
  price: {
    ...
    plans: [
      { id: 'monthly', name: 'Mensal', price: 'AU$15', period: '/mês', fullPrice: null, note: null, badge: null },
      {
        id: 'semiannual',
        name: 'Semestral',
        price: 'AU$81',
  ...
  footer: {
    ...
    storeBadges: { comingSoon: 'Em breve na', getIt: 'Disponível no', appStore: 'App Store', googlePlay: 'Google Play' },
    columns: { product: 'Produto', follow: 'Siga-nos', legal: 'Legal', connect: 'Conectar' },
    productLinks: ['Recursos', 'Preço', 'Perguntas', 'Contato', 'Guia', 'Blog'],
