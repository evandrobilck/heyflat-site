export default {
  ...
  hero: {
    ...
    subtitle:
      'Cuentas, tareas, compras y avisos, todo en una sola app, repartido de forma justa entre tus compañeros. Se acabó cobrarle a todo el mundo.',
  ...
  mockup: {
    greeting: 'Hola, Evandro',
    location: 'Estás en Pohlman Street',
    house: 'Pohlman Street',
    roommateCount: '4 compañeros',
    nav: { home: 'Inicio', bills: 'Cuentas', chores: 'Tareas', shopping: 'Compras', maintenance: 'Mantenimiento' },
    youOwe: 'Debes',
    owedToYou: 'Te deben',
    monthBadge: 'Mes',
    roommateOfMonth: 'Compañero del mes',
  ...
  price: {
    ...
    plans: [
      { id: 'monthly', name: 'Mensual', price: 'AU$15', period: '/mes', fullPrice: null, note: null, badge: null },
      {
        id: 'semiannual',
        name: 'Semestral',
        price: 'AU$81',
