export default {
  ...
  hero: {
    ...
    subtitle:
      'Bills, chores, shopping and reminders, all in one app, split fairly between roommates. No more chasing anyone.',
  ...
  mockup: {
    greeting: 'Hi, Evandro',
    location: "You're at Pohlman Street",
    house: 'Pohlman Street',
    roommateCount: '4 roommates',
    nav: { home: 'Home', bills: 'Bills', chores: 'Chores', shopping: 'Shopping', maintenance: 'Maintenance' },
    youOwe: 'You owe',
    owedToYou: 'Owed to you',
    monthBadge: 'Month',
    roommateOfMonth: 'Roommate of the month',
  ...
  price: {
    ...
    plans: [
      { id: 'monthly', name: 'Monthly', price: 'AU$15', period: '/mo', fullPrice: null, note: null, badge: null },
      {
        id: 'semiannual',
        name: 'Semiannual',
        price: 'AU$81',
  ...
  footer: {
    ...
    storeBadges: { comingSoon: 'Coming soon to', getIt: 'Get it on', appStore: 'App Store', googlePlay: 'Google Play' },
    columns: { product: 'Product', follow: 'Follow us', legal: 'Legal', connect: 'Connect' },
    productLinks: ['Features', 'Pricing', 'FAQ', 'Contact', 'Guide', 'Blog'],
